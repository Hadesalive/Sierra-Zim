 ...
 * 3px ink grout grid, each led by a big amber numeral. Steps come from the Home
 * global (certPathSteps).
 */
export function TheStandard({ steps }: { steps: HomeContent["certPathSteps"] }) {
  return (
      ...
      <div className="mx-auto w-full max-w-[90rem] px-6 py-[104px] sm:px-14">
        <div className="mb-16 flex flex-wrap items-baseline gap-x-6 gap-y-3">
          ...
          <p className="font-mono text-[12px] uppercase tracking-[0.24em] text-safety-600">
            No shortcuts — theory and practical, both passed
          </p>
        </div>
