...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "home" ADD COLUMN "cta_secondary" "enum_home_cta_secondary";
  ...
  ALTER TABLE "about_page" ADD COLUMN "cta_secondary" "enum_about_page_cta_secondary";
  ...
  ALTER TABLE "services_page" ADD COLUMN "cta_secondary" "enum_services_page_cta_secondary";
  ...
  ALTER TABLE "portfolio_page" ADD COLUMN "cta_secondary" "enum_portfolio_page_cta_secondary";
  ...
  ALTER TABLE "gallery_page" ADD COLUMN "cta_secondary" "enum_gallery_page_cta_secondary";
